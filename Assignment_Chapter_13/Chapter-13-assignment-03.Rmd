...
# build a distance matrix for age? 




# don't know how to include varying slope, slope and intercept covary, need to consider, and how to include distance matrix for both intercept and slope  
m13H2 <- map2stan(
  alist(
    height ~ dnorm(mu, sigma),
    mu <- a + a_subject[subject] + b*age,
