...
# I cannot get the right plot, but I guess the two are masking the effect of each other because they are highly correlated. 
####################################################
```
...
# based on number, looks like avgfood, I would choose avgfood
